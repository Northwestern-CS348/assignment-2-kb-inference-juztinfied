...
class KBTest(unittest.TestCase):
    ...
    #     answer = self.KB.kb_ask(ask1)
    #     self.assertEqual(str(answer[0]), "?X : chen")
    #     r1 = read.parse_input("fact: (fairyof ada chen)")
    #     self.KB.kb_retract(r1)
    #     answer = self.KB.kb_ask(ask1)
    #     print(answer)
    ...
    # def test6(self):
    #     # makes sure retracting facts also retracts all inferred facts down the
    #     r1 = read.parse_input("fact: (motherof ada bing)")
    #     print(' Retracting', r1)
    #     self.KB.kb_retract(r1)
    #     ask1 = read.parse_input("fact: (cooksfor ada chen)") 
    #     print(' Asking if', ask1)
    #     answer = self.KB.kb_ask(ask1)
    #     print(answer)
    ...
    def test6(self):
        ...
        print(' Retracting', r1)
        self.KB.kb_retract(r1)
        ask1 = read.parse_input("fact: (cooksfor ?Y chen)") 
        print(' Asking if', ask1)
        answer = self.KB.kb_ask(ask1)
        self.assertEqual(str(answer[0]), "?Y : ada")
        r2 = read.parse_input("fact: (kindto ada chen)")
        self.KB.kb_retract(r2)
        answer = self.KB.kb_ask(ask1)
        self.assertEqual(str(answer[0]), "?Y : ada")
